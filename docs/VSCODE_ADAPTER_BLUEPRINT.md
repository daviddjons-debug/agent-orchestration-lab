...
## Next required step
After this document, the next canonical adapter should define either:
- Antigravity attachment model, or
- the canonical bounded task prompt template shared across adapters.
