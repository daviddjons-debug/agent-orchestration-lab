...
In the current runtime baseline, this structured ring is mechanically enforced by the Builder (required object with primary/adjacent/verify-only/excluded fields aligned to dependency_ring).
