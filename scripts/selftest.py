        ...
        json.dumps(
            {
                ...
                "blockers_or_uncertainties": ["the runnable lab does not enforce any stage-wide mechanically enforced read control beyond the current Builder-enforced read-boundary payload"],
